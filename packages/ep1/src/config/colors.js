...
// Lerp between two hex colors (standalone, returns hex string)
...
// Lerp between two hex colors using p5 (returns p5 color)
export function lerpColorP5(p5, hex1, hex2, t) {
...
// Get RGB values from a color for direct use
